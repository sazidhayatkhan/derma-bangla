...
const SectionFour = (props: Props) => {
  return (
    <div className='_container'>
      ...
      <div className="">
        <p className="__greatVibes text-center text-white text-4xl mb-3">
          Experience the Magic of Christmas
        </p>
        <p className="__chewy text-white text-6xl w-[67%] text-center mx-auto mb-6">Explore Our Festive Wonderland of Holiday Delights</p>
